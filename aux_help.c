...
/**
 * aux_help_general - Displays all possible builtin shellby commands.
 */
...
/**
 * aux_help_alias - Displays information on the shellby
...
/**
 * aux_help_cd - Displays information on the shellby builtin command 'cd'.
 */
void aux_help_cd(void)
{
...
/**
 * aux_help_exit - Displays information on the shellby builtin command 'exit'.
 */
void aux_help_exit(void)
{
...
/**
 * aux_help - Displays information on the shellby builtin command 'help'.
 */
void aux_help(void)
{
